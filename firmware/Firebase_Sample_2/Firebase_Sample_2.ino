...
#define WIFI_SSID "SINGTEL-WNP6"
#define WIFI_PASSWORD "thanhxuan"

// For the following credentials, see examples/Authentications/SignInAsUser/EmailPassword/EmailPassword.ino

/* 2. Define the API Key */
#define API_KEY "AIzaSyDEAP1XKmK8t1qt4fuXYN2ndZ3pbNNlLTU"

/* 3. Define the RTDB URL */
#define DATABASE_URL "smarthomeapp-982da-default-rtdb.asia-southeast1.firebasedatabase.app" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app

/* 4. Define the user Email and password that alreadey registerd or added in your project */
#define USER_EMAIL "nguyenvanthanh2210@gmail.com"
