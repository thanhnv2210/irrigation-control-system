...
const styles = {
  ...
  deviceText:   { color: '#7aab90', fontSize: '0.78rem', flex: 1 },
  iconBtn:      { background: 'transparent', border: '1px solid #3a5a45', borderRadius: '5px', color: '#7aab90', fontSize: '0.75rem', padding: '0.1rem 0.4rem', cursor: 'pointer', flexShrink: 0, lineHeight: 1.4 },
